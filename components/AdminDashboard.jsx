...
const AdminDashboard = ({ children }) => {
    ...
    const memoizedLinks = useMemo(() => [
        ...
        {
            pathname: '', icon: <GoFileDirectoryFill size={20} />, text: 'Songs', arrow: <MdKeyboardArrowDown size={20} />,
            subItems: [
                { pathname: '/admin/songs/add-songs', icon: <FaPlus size={20} />, text: 'Add Songs' },
                { pathname: '/admin/songs/all-songs', icon: <MdEditSquare size={20} />, text: 'All Songs' },
            ], hasSubItems: true
        },
